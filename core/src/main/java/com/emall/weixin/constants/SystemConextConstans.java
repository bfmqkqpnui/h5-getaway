...
public class SystemConextConstans {
	...
	public final static String PARKING_APP_PATH="parkingAppPath";
	public final static String HTTPS_APP_PATH="httpsAppPath";
	// H5路径
	...
	public final static String  FILED_OLD_MEMBER_EVENT = "oldMemberEvent";
	//订单来源渠道
	...
	// cps 投放批次号
    public final static String FILED_CPA_BATCH_ID="batch_id";
    ...
    // 人人惠营销员分享 session key
    public final static String FILED_RENRENHUI_SHARE_INFO="renrenhui_share";
    //营销员id
    public final static String FILED_TO_USER_PUB="codeKey";
    //是否为营销员  1是  0不是
    public final static String FILED_TO_USER_IS_SALESMAN="isSalesman";
    //广告身份标识
    ...
    // 秒杀来源标示
    public final static String FILED_SECKILLFLAG="seckillFlag";
    //会员手机号
    public final static String MEMBER_MOBILE = "mobile";
    //会员手机号加密
    public final static String MEMBER_ENCODE_MOBILE = "encode_mobile";
    //是否为新注册会员
    public final static String MEMBER_NEWREGFLAG = "newRegFlag";
    //是否为营销员
    public final static String MEMBER_ISSALESMAN = "isSalesman";
}
