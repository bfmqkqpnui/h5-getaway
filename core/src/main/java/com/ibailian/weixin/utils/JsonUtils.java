...
public class JsonUtils {
    public static <T> T jsonString2Bean(String jsonStr, Class<T> clz) throws IOException {
        try {
            return JSON.parseObject(jsonStr, clz);
        } catch (Exception arg2) {
            throw new IOException("jsonString2Bean转换异常", arg2);
        }
    }

    public static <T> List<T> josn2List(String jsonStr, Class<T> clz) throws Exception {
